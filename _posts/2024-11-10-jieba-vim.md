...
| [最新稳定版][jieba-vim-stable] (v1.0.4) | 目前已完成 normal/visual/operator-pending 模式下的 {count}w/W/e/E/b/B/ge/gE/. 键位，欢迎下载试用。 | Rust + python3 | Apache v2.0 |
| [最新进展][jieba-vim-prerelease] (rust) | 将尝试支持 [`'iskeyword'`][vim-iskeyword] Vim 选项。 | Rust + python3 | Apache v2.0 |
...
[jieba-vim-stable]: https://github.com/kkew3/jieba.vim/releases/tag/v1.0.4
